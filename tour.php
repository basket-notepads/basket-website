...
<?php echoH2(); ?>
   ...
   <p>BasKet Note Pads is a note-taking application that makes it easy to write down ideas as you think, and quickly find them back later. Organizing your notes has never been so easy.</p>

   <p>There is enough of flat note-taking applications that only let you to write text. BasKet Note Pads offers a big expression freedom by collecting any type of data. It is ideal to bring together all the information about a project in one place: you can take images, group needed documents, link them email addresses of the members, link to various interesting websites...</p>

   <p>In a few weeks, there will be here several use-cases where BasKet Note Pads shine and is essential.<br>
     For the moment, you can view the <a href="screenshots.php">numerous screenshots</a> or go <a href="index.php">back to home</a> to learn the key features of BasKet Note Pads.</p>
